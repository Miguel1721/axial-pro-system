...
// const LandingPage = React.lazy(() => import('./pages/LandingPage')); // Temporalmente deshabilitado por error de sintaxis
    ...
    <AccessibilityProvider>
      <NotificationProvider>
        ...
        >
          ...
          {/* Temporalmente deshabilitado por error de sintaxis en LandingPage.jsx
