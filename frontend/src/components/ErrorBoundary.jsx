...
const DefaultErrorUI = ({ error, errorId, onReset, onReload, onGoHome }) => {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-4 ${
      ...
      <div className={`max-w-md w-full ${isDark ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-2xl p-8`}>
        {/* Icono de error */}
        ...
        {import.meta.env.DEV && error && (
          <details className={`mb-6 p-4 rounded-lg ${
